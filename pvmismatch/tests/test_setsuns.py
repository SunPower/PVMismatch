...
def test_basic():
    pvsys = PVsystem()
    pvsys.setSuns(.75)
    ok_(np.isclose(pvsys.Pmp, 23975.249137290117))
...
def test_dictionary():
    ...
    pvsys.setSuns(Ee)
    ok_(np.isclose(pvsys.Pmp, 31612.243752486283))
...
def test_set_mod_1():
    ...
    Ee = {1: {3: [.2], 0: [.1]}}
    pvsys.setSuns(Ee)
    ok_(np.isclose(pvsys.Pmp, 29573.207099602125))
...
def test_set_str_1():
    ...
    Ee = {1: [.1]}
    pvsys.setSuns(Ee)
    ok_(np.isclose(pvsys.Pmp, 29159.47988039567))

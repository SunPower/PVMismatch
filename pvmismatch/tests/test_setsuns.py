...
def test_basic():
    pvsys = PVsystem()
    pvsys.setSuns(.75)
    ok_(np.isclose(pvsys.Pmp, 23906.929813407343))
...
def test_dictionary():
    ...
    pvsys.setSuns(Ee)
    ok_(np.isclose(pvsys.Pmp, 31614.872508745437))
...
def test_set_mod_1():
    ...
    Ee = {1: {3: [.2], 0: [.1]}}
    pvsys.setSuns(Ee)
    ok_(np.isclose(pvsys.Pmp, 29567.354757496352))
...
def test_set_str_1():
    ...
    Ee = {1: [.1]}
    pvsys.setSuns(Ee)
    ok_(np.isclose(pvsys.Pmp, 29137.429860738754))
